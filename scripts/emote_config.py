...
class Emote_Config:
    def __init__(self, finetune, model_name, portion, seed, hfpath):
        ...
        self.train_csv_fp = '/content/ELCo/benchmark_data/exp-entailment/train.csv'
        self.val_csv_fp = '/content/ELCo/benchmark_data/exp-entailment/val.csv'
        self.test_csv_fp = '/content/ELCo/benchmark_data/exp-entailment/test.csv'
